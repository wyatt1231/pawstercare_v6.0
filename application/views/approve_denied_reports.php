	...
	<section class="content">
		...
		<div class="row">
			...
			<div class="col-xs-12">
							...
							<div class="col-xs-12">			
									<div class="box box-primary box-solid">
										<div class="box-header with-border">
											<h3 class="box-title">Total Approved, Denied and Pending Reports</h3>
              ...
              <div class="box-body" style="">
              	...
              	<div>
              		<!--<div id='myChart4'><a class="zc-ref" href="https://www.zingchart.com/">Charts by ZingChart</a></div>-->
              		 <div id="report4" style="height: 550px;"></div>
              	</div>
              </div>
              <!-- /.box-body -->
      ...
      <!-- /.box-footer-->
			...
			<div class="col-md-12" important>
				<div class="card" important style="width:212% ; margin-left:270px;margin-top:-15px; margin-top:-10px;">
...
<script>
 $("#yer").change(function (e) { 
            ...
            var yer= $("#yer").val();
            if (yer === "2018") {
               var jsonData = $.getJSON("<?php echo base_url('user/report42018');?>", function (jsonData) {
  ...
  labels: ['Value']
                 ...
                 var jsonData = $.getJSON("<?php echo base_url('user/report42019');?>", function (jsonData) {
        console.log(jsonData); 
  ...
  labels: ['Value']
                 ...
                 var jsonData = $.getJSON("<?php echo base_url('user/report42020');?>", function (jsonData) {
        console.log(jsonData); 
...
zingchart.bind('myChart4','node_click',updateChart);

zingchart.bind('myChart4', 'shape_click', function(p){ // Listen for back button click
